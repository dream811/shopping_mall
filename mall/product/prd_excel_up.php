    ...
    <table><tr><td></td></tr></table>
     <table cellspacing="2" cellpadding="0" border="0">
       <tr>
        ...
        <td>
        	<input type="file" name="upfile" class="input"> <a href="../../admin/product/prd_sample.xls"><b><font color="black">[샘플다운로드]</font></b></a>
        </td>
		</tr>
       <tr>
	...
	if($upfile[size] > 0){
		...
		for($ii = 1; $ii < count($prdinfo); $ii++) {
			...
			$sql = "insert into wiz_product(prdcode, prdname, new, best, popular, recom, sale, brand, prdcom, origin, showset,
						...
						prdimg_L3,prdimg_M3,prdimg_S3,prdimg_L4,prdimg_M4,prdimg_S4,prdimg_L5,prdimg_M5,prdimg_S5,stortexp,content,wdate,mallid,status)
						...
						'".$prdimg_L5_name."','".$prdimg_M5_name."','".$prdimg_S5_name."','".$stortexp."','".$content."',now(),'".$wiz_mall['id']."','N')";
