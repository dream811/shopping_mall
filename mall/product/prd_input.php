            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="2" class="t_style">
                ...
                <td class="t_value">
                	<select name="mallid" onChange="setCmsRate();">
                		<?php
                		$sql = "select id, com_name, cms_type, cms_rate from wiz_mall where status = 'Y' and id = '".$wiz_mall['id']."' order by com_name asc";
                		$result = mysqli_query($connect, $sql) or die(mysqli_error($connect));
                ...
                <td class="t_value">
                	<? if($prd_row->status == "Y") echo "<font color='blue'>승인</font>"; else echo "<font color='red'>미승인</font>"; ?>
                </td>
              </tr>
              <tr>
                ...
                <? if($mode == "update"){ ?>
					<input type="button" value="분류추가" onCLick="javascript:prdCategory()" />
                <? } ?>
                </td>
              </tr>
              <tr>
        ...
        <tr>
          <td>
            <table width="100%" border="0" cellspacing="1" cellpadding="2" class="t_style">
              ...
              <tr>
                <td class="t_name">적립금<br><? if($reserve_use == "Y") echo "(판매가 ".$reserve_buy." %)"; ?></td>
          ...
          <td>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="2" class="t_style">
              <tr>
				...
				<input type="button" onclick="openOption('opt5');" value="불러오기"> 옵션은 컴마(,)로 구분
                </td>
              </tr>
              <tr>
				...
				<input type="button" onclick="openOption('opt6');" value="불러오기"> ex(95,100,105...)
                </td>
              </tr>
              <tr>
				...
				<input type="button" onclick="openOption('opt7');" value="불러오기">
                </td>
              </tr>
            </table>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="2" class="t_style">
              <tr>
                ...
                <td width="85%" class="t_value" colspan="3">
					...
					<input type="button" onclick="openOption('opt3');" value="불러오기">
              ...
              <tr>
                ...
                <td class="t_value" colspan="3">
					...
					<input type="button" onclick="openOption('opt4');" value="불러오기">
