   ...
   if(frm.admin_pw.value == ""){
	...
	if(frm.secure_login != undefined) {
		if(!frm.secure_login.checked){
			frm.action = "/mall/admin_check.php";
		}
	}
}
...
<form name="frm" action="<?=$ssl?>/mall/admin_check.php" method="post" onSubmit="return inputCheck(this);">
<div class="AW-admin-login_wrap">
    ...
    <div class="form">
    	<dl>
        	<dt>ID</dt>
            <dd><input type="text" name="admin_id" value="testmall" placeholder="아이디를 입력하세요" /></dd>
        </dl>
    	<dl>
        	<dt>PASSWORD</dt>
