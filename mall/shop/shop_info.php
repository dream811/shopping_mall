...
<script language="javascript">
  ...
  function inputCheck(frm) {
    ...
    if (frm.acc_bank.value == "") {
      alert("은행명을 입력하세요");
      frm.acc_bank.focus();
      return false;
    }
    if (frm.acc_num.value == "") {
      alert("계좌번호를 입력하세요");
      frm.acc_num.focus();
      return false;
    }
    ...
    if (frm.com_tel.value == "") {
      ...
      frm.com_tel.focus();
      return false;
    } else if (!Check_Num(frm.com_tel.value)) {
    ...
    if (frm.com_tel2.value == "") {
      ...
      frm.com_tel2.focus();
      return false;
    } else if (!Check_Num(frm.com_tel2.value)) {
      alert("국번은 숫자만 가능합니다.");
      frm.com_tel2.focus();
      return false;
    }
    ...
    if (frm.com_tel3.value == "") {
      ...
      frm.com_tel3.focus();
      return false;
    } else if (!Check_Num(frm.com_tel3.value)) {
