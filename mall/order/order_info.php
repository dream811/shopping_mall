...
function sendEmail(name,email){
	var url = "send_email.php?seluser=" + name + ":" + email;
...
function sendSms(name,hphone){
	var url = "send_sms.php?seluser=" + hphone;
...
function searchZip(){
	...
	var url = "../shop/search_zip.php?kind=send_";
...
function searchZip2(){
	...
	var url = "../shop/search_zip.php?kind=rece_";
          ...
          <td height="30" colspan="8" style="padding:3px">
            <table border="0"width="100%" cellspacing="0" cellpadding="5" bgcolor="#EFEFEF" class="t_style">
              <tr>
                ...
                <td class="t_value" align="right"><input type="submit" value="적용" /></td>
              </tr>
            </table>
          </td>
        </tr>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="6" class="t_style">
              ...
              <tr>
                ...
                <td class="t_value" colspan="3">
                  ...
                  <input type="button" value="우편번호 검색" onClick="searchZip2();" />
                </td>
              </tr>
              <tr>
                <td class="t_name">주소</td>
