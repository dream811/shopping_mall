...
$page_type = "myshop";
$now_position = "<a href=/>Home</a> &gt; 마이쇼핑 &gt; 비밀번호 변경";
...
<table border=0 cellpadding=0 cellspacing=0 width=98% align=center>
		...
		<td align=center style="padding:5 0 10 0">
			...
			<table border=0 cellpadding=0 cellspacing=0>
				<tr>
					...
					<td><a href="../member/my_out.php"><img src="/images/myshop_m_08.gif" border=0></a></td>
				</tr>
				<tr>
					<td colspan=8 background="/images/myshop_01.gif" height=57 style="padding:0 0 0 25">
						<img src="/images/myshop_icon.gif" align=absmiddle>
	...
	<form name="frm" action="my_save.php" method="post" onSubmit="return inputCheck(this)">
		...
		<tr>
			<td align=center>
				<table border=0 cellpadding=0 cellspacing=0 width=690>
					<tr>
						<td><img src="/images/myshop_m07_01.gif"></td>
					</tr>
					<tr>
						<td bgcolor=#939393 height=3></td>
					</tr>
					<tr>
						<td>
							...
							<table border=0 cellpadding=0 cellspacing=0 width=100%>
								<tr height=28>
									...
									<td><input type=password name="pre_passwd" size=20 class="input">&nbsp;&nbsp;&nbsp;<span class="s11">(4자 이상의 영문, 숫자)</span></td>
								</tr>
								<tr>
								...
								<tr height=28>
									...
									<td><input type=password name="passwd" size=20 class="input">&nbsp;&nbsp;&nbsp;<span class="s11">(4자 이상의 영문, 숫자)</span></td>
								</tr>
								<tr>
									<td colspan=3 bgcolor=#eeeeee></td>
								</tr>
								<tr height=28>
									...
									<td><input type=password name="passwd2" size=20 class="input">&nbsp;&nbsp;&nbsp;<span class="s11">(4자 이상의 영문, 숫자)</span></td>
								</tr>
							</table>
		...
		<tr>
			<td colspan="5" align="center" height=63>
