			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td background="/images/member/mypage_bg03.gif">
								...
								<td width="10%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<? if (strpos($PHP_SELF, "_shop") !== false) { ?>
												<td width="8"><img src="/images/member/on_bg01.gif"></td>
												<td align="center" background="/images/member/on_bg03.gif"><a href="../member/my_shop.php"><img src="/images/member/tab_on01.gif" border="0" align="absmiddle"></a></td>
												<td width="8"><img src="/images/member/on_bg02.gif"></td>
											<? } else { ?>
												<td width="8"><img src="/images/member/mypage_bg01.gif"></td>
												<td align="center"><a href="../member/my_shop.php"><img src="/images/member/tab_01.gif" border="0" align="absmiddle"></a></td>
								...
								<td width="10%">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<? if (strpos($PHP_SELF, "_wish") !== false) { ?>
												<td width="8"><img src="/images/member/on_bg04.gif"></td>
												<td align="center" background="/images/member/on_bg03.gif"><a href="../member/my_wish.php"><img src="/images/member/tab_on05.gif" border="0" align="absmiddle"></a></td>
												<td width="8"><img src="/images/member/on_bg02.gif"></td>
											<? } else { ?>
												<td width="8"></td>
												<td align="center"><a href="../member/my_wish.php"><img src="/images/member/tab_05.gif" border="0" align="absmiddle"></a></td>
												<td width="8"><img src="/images/member/line.gif"></td>
											<? } ?>
					...
					<td background="/images/member/mypage_bg06.gif">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td style="padding:0 0 0 15;"><img src="/images/myshop_icon.gif" align=absmiddle>
									<font color=#ADFFFC><b><?= $wiz_session['name'] ?></b></font>
									<font color=#ffffff><b> 님의 마이쇼핑입니다.</b></font>
								</td>
								...
								<td>
									<table border=0 cellpadding=0 cellspacing=0 width=100%>
										...
										<tr>
											...
											<td> : <?= number_format($total_price) ?>원 (배송완료기준) &nbsp;<a href="../member/my_info.php"><img src="/images/but_infomodify.gif" border=0 align=absmiddle></a></td>
										</tr>
										<tr>
											<td height=1 bgcolor=#dadada colspan=2></td>
										</tr>
										<tr>
											...
											<td> : <?= number_format($total_reserve) ?>원 &nbsp;<a href="../member/my_reserve.php"><img src="/images/but_pointlist.gif" border=0 align=absmiddle></a></td>
										</tr>
										<tr>
											<td height=1 bgcolor=#dadada colspan=2></td>
										</tr>
