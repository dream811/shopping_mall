...
if($mode == "write"){
  ...
  if(!strcmp($bbs_info[spam_check], "Y")) {
	...
	echo "<script>document.location='".$bbs_info['list_url']."?code=$code&mallid=$mallid';</script>";
...
////////////////////////////////////////////////////////////////////////////////
	...
	comalert("수정 되었습니다.","".$bbs_info['view_url']."?idx=$idx&$param");
...
////////////////////////////////////////////////////////////////////////////////
  ...
  if(!strcmp($bbs_info['spam_check'], "Y")) {
	...
	echo "<script>document.location='".$bbs_info['list_url']."?$param';</script>";
...
////////////////////////////////////////////////////////////////////////////////
	...
	comalert("삭제 되었습니다.","".$bbs_info['list_url']."?$param");
...
////////////////////////////////////////////////////////////////////////////////
  ...
  $result = mysqli_query($connect, $sql) or die(mysqli_error($connect));
	...
	comalert("댓글을 작성하였습니다.", "".$bbs_info['view_url']."?code=$code&mallid=$mallid&idx=$idx");
...
////////////////////////////////////////////////////////////////////////////////
  ...
  // 댓글수 업데이트
	$sql = "select idx from wiz_comment where cidx='$bbs_idx'";
	$result = mysqli_query($connect, $sql) or die(mysqli_error($connect));
	$comment = mysqli_num_rows($result);

	$sql = "update wiz_bbs set comment = '$comment' where idx = '$bbs_idx'";
	mysqli_query($connect, $sql) or die(mysqli_error($connect));

	comalert("댓글을 삭제하였습니다.", "".$bbs_info['view_url']."?code=$code&mallid=$mallid&idx=$bbs_idx");
...
////////////////////////////////////////////////////////////////////////////////
	...
	if(strlen($_COOKIE["bbs_recom".$idx])==0){
		...
		echo "<script>alert('추천되었습니다.');document.location='".$bbs_info['view_url']."?code=$code&mallid=$mallid&idx=$idx&recom=ok';</script>";

	}else{

		echo "<script>alert('한번만 추천가능합니다..');document.location='".$bbs_info['view_url']."?code=$code&mallid=$mallid&idx=$idx';</script>";
	}
}
?>