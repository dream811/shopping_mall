<?php
include $_SERVER['DOCUMENT_ROOT']."/inc/bbs_info_set.inc"; 	 								// 게시판 정보
...
// 버튼설정
$list_btn = "<a href='".$bbs_info['list_url']."?code=$code&mallid=$mallid'><img src='$skin_dir/image/btn_list.gif' border='0'></a>";
if($wpermi >= $mem_level) {
	$write_btn = "<a href='".$bbs_info['input_url']."?mode=write&code=$code&mallid=$mallid'><img src='$skin_dir/image/btn_write.gif' border='0'></a>";
} else {
...
if($mybbs) $my_sql=" and (memid='".$wiz_session['id']."' or memgrp like '".$wiz_session['id'].",%' or mallid = '".$wiz_session['id']."') ";
