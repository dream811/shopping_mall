...
?>
			...
			<table border="0" cellspacing="0" cellpadding="2">
			  <tr>
			    ...
			    <td valign="bottom" class="tit">회사소개</td>
			    <td width="2"></td>
			    <td valign="bottom" class="tit_alt">회사소개 페이지를 설정합니다.</td>
			  </tr>
			</table>
...
<input type="hidden" name="page" value="page_company.php">
      <table width="100%" border="0" cellspacing="1" cellpadding="2" class="t_style">
		<!--
        <tr> 
         <td width="15%" height="25" align="left" class="t_name">상단이미지</td>
		...
		-->
        <tr>
        	<td width="15%" class="t_name">회사소개</td>
			<td class="t_value">
          <?
          $edit_height = "500";
