...
?>
			...
			<table border="0" cellspacing="0" cellpadding="2">
			  <tr>
			    ...
			    <td valign="bottom" class="tit">입점신청</td>
			    <td width="2"></td>
			    <td valign="bottom" class="tit_alt">입점신청 페이지를 설정합니다.</td>
			  </tr>
			</table>
      ...
      <input type="hidden" name="page" value="page_malljoin.php">
      <table width="100%" border="0" cellspacing="1" cellpadding="2" class="t_style">
       ...
       <tr>
		...
		-->
        <tr>
          <td width="15%" class="t_name">입점약관 </td>
          <td class="t_value">
          	<textarea name="content" rows="12" cols="60" style="width:100%; padding:10 10 10 10" class="textarea"><?=$page_info->content?></textarea>
          </td>
        </tr>
      </table>
