...
?>
			...
			<table border="0" cellspacing="0" cellpadding="2">
			  <tr>
			    ...
			    <td valign="bottom" class="tit">개인정보보호정책</td>
			    <td width="2"></td>
			    <td valign="bottom" class="tit_alt">개인정보보호정책을 설정합니다.</td>
			  </tr>
			</table>
      ...
      <input type="hidden" name="page" value="page_privacy.php">
      <table width="100%" border="0" cellspacing="1" cellpadding="2" class="t_style">
       ...
       <tr> 
		...
		-->
        <tr>
          <td width="15%" align="center" class="t_name">개인정보보호정책 </td>
          <td class="t_value">
          <?
          $edit_height = "500";
