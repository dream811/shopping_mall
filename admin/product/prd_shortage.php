...
function editOption(prdcode){
	...
	window.open(url,"editOption","height=400, width=700, menubar=no, scrollbars=yes, resizable=yes, toolbar=no, status=no");
...
//-->
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td align="right"><a onClick="excelDown();" class="AW-btn">엑셀파일저장</a></td>
        </tr>
      ...
      <?
	     ...
	     <tr class="t_tr">
          ...
          <td align="center"><input type="submit" class="AW-btn-s modify" value="수정" /> <a onClick="editOption('<?=$row->prdcode?>');" class="AW-btn-s">옵션</a></td>
        </tr>
