...
function print_position($catcode){
   ...
   $now_position .= " <a href=prd_save.php?mode=catlist&submode=delete&prdcode=$prdcode&catcode=$catcode class=AW-btn-s del>삭제</a>";
...
<table width="98%" align="center" border="0" cellspacing="1" cellpadding="2" class="t_style">
  ...
  <tr> 
    ...
    <input type="submit" value="등록하기" class="AW-btn-s" />
    </td>
  </tr>
</table>
</form>
