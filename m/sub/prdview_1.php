...
function setSellprice(){
	...
	document.getElementById("total_price").innerHTML = "총 상품 금액 <b>"+ won_Comma(total_price) +"</b> 원";
...
<div class="prd_view">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="75" valign="top"><img src="<?=$prd_info->prdimg_M1?>" width="75" height="75" /></td>
        <td style="padding-left:15px;" valign="top">
        	<div class="prd_tit"><?=$prd_info->prdname?></div>
            <div style="padding-top:8px;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_normal">
            	<? if($prd_info->conprice > $prd_info->sellprice){ ?>
              <tr>
                <th>정상가</th>
                <td><span style="text-decoration:line-through;"><?=number_format($prd_info->conprice)?>원</span></td>
              </tr>
            	<? } ?>
              <tr>
                <th>상품가격</th>
                <td><font class="prd_price"><?=$sellprice?></font></td>
              </tr>
              <? if($oper_info->reserve_use == "Y" && empty($prd_info->strprice)){ ?>
              <tr>
                <th>적립금</th>
                <td><?=number_format($prd_info->reserve)?>원</td>
              </tr>
              <? } ?>
            </table>
            </div>
            <div style="padding-top:5px;"><input type="button" value="Photo Gallery ▶" class="btn_gray_small" style="width:80px;" onClick="prdZoom()" /></div>
        </td>
      </tr>
    </table>
</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <th><a href="prdview_1.php?prdcode=<?=$prdcode?>&<?=$param?>">상품정보</a></th>
    <td><a href="prdview_2.php?prdcode=<?=$prdcode?>&<?=$param?>">상품 상세보기</a></td>
    <td><a href="prdview_3.php?prdcode=<?=$prdcode?>&<?=$param?>">상품리뷰<small>(<?=$review_total?>)</small></a></td>
  </tr>
</table>
</div>
...
<div class="prd_info">
<table width="93%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_normal">
  <tr>
    <th>판매가</th>
    <td id="sellprice"><font class="prd_price"><?=$sellprice?></font></td>
  </tr>
	<?php
  ...
  <tr>
    <th>등급할인액</th>
    <td><?=number_format($member_price)?>원 &nbsp;<?=number_format($row->discount)?><?=$row->distype?> [<?=$level?>]</td>
  </tr>
	<?
		}
	}
...
<table width="93%" border="0" cellspacing="0" cellpadding="0" align="center" class="table_normal">
  ...
  ?>
  <tr>
    <th><?=$prd_info->{"info_name".$ii}?></th>
    <td><?=$prd_info->{"info_value".$ii}?></td>
  </tr>
  <?php
  		}
  	}
...
<table width="93%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td class="prd_list_option_tit"><?=$prd_info->opttitle5?></td>
    <td>
  ...
  <tr>
    <td class="prd_list_option_tit"><?=$prd_info->opttitle6?></td>
    <td>
  ...
  <tr>
    <td class="prd_list_option_tit"><?=$prd_info->opttitle7?></td>
    <td>
  ...
  <tr>
    <td class="prd_list_option_tit"><?=$prd_info->opttitle3?></td>
    <td>
  ...
  <tr>
    <td class="prd_list_option_tit"><?=$prd_info->opttitle4?></td>
    <td>
  ...
  ?>
  <tr>
    <td class="prd_list_option_tit"><?=$prd_info->opttitle?><?=$prd_info->opttitle2?></td>
    <td>
				<?php
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><b>빨간색, M</b></td>
    <td width="15%"><input type="text" value="1" style="width:39px;" class="input_style" /></td>
    <td width="20%">145,000원</td>
    <td width="1%"><img src="../img/sub/btn_x.gif" /></td>
  </tr>
</table>
</div-->
<div class="total_price" id="total_price">총 상품 금액 <b><?=str_replace("원", "", $sellprice)?></b> 원</div>
<div class="btn">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="left"><table width="100%" border="0" cellpadding="0" cellspacing="0" align="left"><tr><td width="5"><img src="../img/sub/btn_gray_left.gif" /></td><td><input type="button" class="btn_order" value="구매하기" onClick="saveBasket('buy')" /></td><td width="5"><img src="../img/sub/btn_gray_right.gif" /></td></tr></table></td>
    <td align="center" style="padding-left:5px; padding-right:5px;"><table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"><tr><td width="5"><img src="../img/sub/btn_white_left.gif" /></td><td><input type="button" class="btn_etc" value="장바구니" onClick="saveBasket('basket')" /></td><td width="5"><img src="../img/sub/btn_white_right.gif" /></td></tr></table></td>
    <td align="right"><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td width="5"><img src="../img/sub/btn_white_left.gif" /></td><td><input type="button" class="btn_etc" value="관심상품" onClick="saveWish()" /></td><td width="5"><img src="../img/sub/btn_white_right.gif" /></td></tr></table></td>
  </tr>
</table>
</div>
