<? include $_SERVER['DOCUMENT_ROOT'].'/m/inc/header.php'; ?>
	...
	<div class="M_contents">
		<div class="prd_list_wrap">
			...
			<ul class="prd_list">
				<li>
					<button type="button" class="wish_btn">관심상품 등록</button><!-- 관심상품에 등록되어있으면 on 클래스 추가 / 없으면 on 클래스 삭제 / 모바일에선 클릭이벤트 없이 관심상품 등록유무 상태만 확인 -->
					<a href="#">
						<span class="best">1</span>
						<div class="img_box">
							<img src="/m/images/prd_img1.jpg" alt="제품이미지" /><!-- 이미지 비율 1:1 -->
						</div>
						<dl>
							<dt>[무료배송/단독 3+1]AL 실리콘 다이닝 테이블매트</dt><!-- 글자 수 최대 45자까지 / 초과 시 말줄임 -->
							<dd>
								<span class="price">
				...
				<li>
					...
					<a href="#">
						...
						<div class="img_box">
							<img src="/m/images/prd_img2.jpg" alt="제품이미지" /><!-- 이미지 비율 1:1 -->
						</div>
						<dl>
							<dt>[무료배송/단독 3+1, 사은품증정]AL 헤링본 다이닝 테이블매트 </dt><!-- 글자 수 최대 45자까지 / 초과 시 말줄임 -->
							<dd>
								<span class="price">
									<strong>1,500</strong>원
								</span>
				...
				<li>
					...
					<a href="#">
						...
						<div class="img_box">
							<img src="/m/images/prd_img3.jpg" alt="제품이미지" /><!-- 이미지 비율 1:1 -->
						</div>
						<dl>
				...
				<li>
					...
					<a href="#">
						...
						<div class="img_box">
							<img src="/m/images/prd_img4.jpg" alt="제품이미지" /><!-- 이미지 비율 1:1 -->
						</div>
						<dl>
							<dt>[단독 2+1]AL 헥사곤 실리콘 컵받침 </dt><!-- 글자 수 최대 45자까지 / 초과 시 말줄임 -->
							<dd>
